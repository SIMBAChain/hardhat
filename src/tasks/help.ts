...
export async function help(
    ...
    switch(helpTopic) {
        ...
        default: { 
           console.log(`${chalk.cyanBright(`\nsimba: Please enter a valid topic from these choices: ${chalk.greenBright(`${JSON.stringify(paramInputChoices)}.`)} For example, run '$ npx hardhat simba help deploy' for help deploying your contract.`)}`);
           break; 
        } 
    }
